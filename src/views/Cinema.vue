    ...
    <template>
      ...
      <div class="addBtn">
        <el-button type="primary"
                   ...
                   @click="showCinemaAdd">新增</el-button>
      </div>
      <div class="
                   tablelist">
        <el-table :data="tableData"
          ...
          <el-table-column prop="cinema_name"
                           label="名称"
                           width="150">
          </el-table-column>
          <el-table-column prop="city.city_name"
                           label="城市"
                           width="200">
          </el-table-column>
          <el-table-column prop="cinema_address"
                           label="地址"
                           width="200">
          </el-table-column>
          <el-table-column label="操作"
            ...
            <template slot-scope="scope">
              <el-button @click="updateCinema(scope.row)"
                         type="primary"
                         size="small">
                <i class="el-icon-edit"></i>
                <span>编辑</span>
              </el-button>
              <el-button @click="deleteCinema(scope.row)"
                         type="danger"
                         size="small">
